pipeline{
    ...
    parameters {
        string(name: 'AMIID', defaultValue: ' ami-28e07e50', description: 'AMI to use. Or use_latest to pull from paramater store')
    }

    environment {
        // Tags
        AWS_ACCOUNT_ID = "231435876663"
        AWS_ACCOUNT_NAME ="trinimbussandbox"
        APPNAME_TAG = "hugh_ruywaypiple_sample"
        APPID_TAG = ""
        ENV_TAG = "dev"
        OWNER_TAG = "hyang@onica.com"
        COSTCENTER_TAG = "Professional Services"
        // Vars for the packer builds
        // packer builder instance SG to use
        SECURITY_GROUPS = 'sg-03f5ab86822425f3f'
        // packer builder subnet to launch in
        SUBNET = 'subnet-0df7af698a7996bb5'
        // region to launch packer builder in
        REGION = 'us-west-2'
        // ami name
        AMI_NAME = "${APPNAME_TAG}-RHEL"
        // Which regions to encrypt and copy the completed AMI to
        EBS_ENCRYPTION_KEY_US_WEST_2 = 'arn:aws:kms:us-west-2:231435876663:key/ee4f1c7e-9f97-4561-bfe0-6fc9cc5954a7'
        // Paramater store values and prefix
        SAVE_AMI_SSM_PARAM_PREFIX="/${APPNAME_TAG}/ami/linux/RHEL7.5/"
        EIS_AMI_SSM_PARAM="/eis/ami/linux/RHEL7.5/latest"
        //Runway var
        IS_JENKINS_MODE = "true"
        // Git creds
        GIT_REPO = "https://github.com/jackcy99/demo_project.git"
        GIT_CREDENTIALS = "hugh_github"
        // Recipient of the notification emails
        EMAIL_RECIPIENT = 'hyang@onica.com' // Multiple emails can be separated by a semi-colon
    }
