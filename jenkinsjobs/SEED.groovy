...
def amibuildjobs = ['ami-pipeline-linux']
// Runway jobs - these are your deployments using runway
// def runwayjobs = ['hugh-runway-app', 'hugh-runway-pre-deploy-setup', 'hugh-runway-pre-deploy-resources']
...
def appname = 'hugh_demo'

// Github credentials and info
def github = 'https://github.com/jackcy99/demo_project.git'
def githubcreds = 'jackcy99'
